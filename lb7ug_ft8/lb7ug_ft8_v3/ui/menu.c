...
static void menu_enc(int32_t d) {
    ...
    switch (active) {
        ...
        case MENU_BFO:
            vfo.bfo_offset+=(int16_t)(d*10); vfo_apply(); break;
        case MENU_MEM:
...
static void menu_btn(void) {
    ...
    switch (active) {
        ...
        case MENU_MODE:  vfo.mode=(radio_mode_t)sel; vfo_apply(); active=MENU_NONE; break;
        case MENU_BW:    vfo.bw_idx=sel; vfo_apply(); active=MENU_NONE; break;
        case MENU_STEP:  vfo.step_idx=sel; vfo.step_hz=step_table[sel]; active=MENU_NONE; break;
        case MENU_RIT:   vfo.rit_on=!vfo.rit_on; vfo_apply(); break;
